...
# Install OpenVPN-AS
curl -O http://swupdate.openvpn.org/as/openvpn-as-2.1.0-Ubuntu14.amd_64.deb
dpkg -i openvpn-as-2.1.0-Ubuntu14.amd_64.deb 
...
rm openvpn-as-2.1.0-Ubuntu14.amd_64.deb 
